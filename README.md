...
<p align="center">
  <strong>🟠 Beta — actively in development</strong>
</p>
...
| **🚨 Breaking & Developing News** | Dedicated live feeds — Breaking News for instant headlines, Developing for ongoing stories. Both auto-refresh every 5 minutes. |
| **🪙 Daily Credit Allowance** | 100 AI search credits per day, shared across AI Chat, Breaking News, and Developing feeds. Credits reset at midnight UTC. |
...
Open News operates on a **daily credit system** during the beta phase:

| Action | Credit Cost |
| :--- | :--- |
| AI Chat search | 1 credit + 1 per source fetched |
| Breaking News refresh | 1 credit per article |
| Developing refresh | 1 credit per article |

> **Daily Limit:** 100 credits — resets at midnight UTC.  
> **Beta Notice:** No payment system is active. We're actively working to expand access — please tune in later for updates!
